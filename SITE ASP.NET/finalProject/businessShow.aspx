...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%;">
        <tr>
            ...
            <td>
                <asp:Button ID="edit" runat="server" OnClick="Button1_Click" Text="Edit" BackColor="#66FF33" Height="25px" Width="41px" />
                &nbsp;
                <asp:Button ID="home" runat="server" OnClick="home_Click" Text="Home" BackColor="#66FF33" Height="25px" style="margin-top: 0px" Width="83px" />
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style18">
                <asp:Button ID="favButt" runat="server" OnClick="favButt_Click" Text="ADD TO MY FAIVORITS" />
                <br />
