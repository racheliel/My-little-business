...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%;">
        <tr>
            ...
            <td>&nbsp;<asp:Button ID="home" runat="server" BackColor="#DADADA" Height="31px" OnClick="home_Click" style="margin-top: 0px" Text="Home" Width="161px" Font-Bold="True" Font-Names="Adobe Hebrew" Font-Size="X-Large" ForeColor="#7B9E46" />
            </td>
        </tr>
        <tr>
